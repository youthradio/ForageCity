...
if($action == 'list') { ?>
	...
	<div id='back-button'>
		<form method='post'>
			...
			<input type='hidden' name='good_description' value='<?php echo htmlspecialchars($good_description); ?>' />
	...
	<div id='save-good-type'>
		...
		<div id='add-box'>
			<form method='post'>
				...
				<span class="good_description error">I can't find that.</span>
		<?php endif; ?></p>
				...
				<p><span class="explanation">What's special about your goods?</span><input type='text' id='good_description' name='good_description' value='<?php echo htmlspecialchars($good_description); ?>' /></p>
				<input type='hidden' name='good_name' value='<?php echo htmlspecialchars($good_name); ?>' />
				<input type='hidden' name='good_type_post' value='<?php echo htmlspecialchars($good_type_post); ?>' />
				<input type='hidden' name='box_number' value='<?php echo htmlspecialchars($box_number); ?>' />
